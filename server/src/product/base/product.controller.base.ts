...
export class ProductControllerBase {
  ...
  @common.Get("/:id/languaes")
  @ApiNestedQuery(LanguageFindManyArgs)
  async findManyLanguaes(
    @common.Req() request: Request,
    @common.Param() params: ProductWhereUniqueInput
  ): Promise<Language[]> {
    const query = plainToClass(LanguageFindManyArgs, request.query);
    const results = await this.service.findLanguaes(params.id, {
      ...query,
      select: {
        audioPreview: true,
        characters: true,
  ...
  @common.Post("/:id/languaes")
  async connectLanguaes(
    @common.Param() params: ProductWhereUniqueInput,
  ...
  @common.Patch("/:id/languaes")
  async updateLanguaes(
    @common.Param() params: ProductWhereUniqueInput,
    @common.Body() body: LanguageWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/languaes")
  async disconnectLanguaes(
    @common.Param() params: ProductWhereUniqueInput,
    @common.Body() body: LanguageWhereUniqueInput[]
  ): Promise<void> {
    const data = {
